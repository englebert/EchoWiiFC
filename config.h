...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      ...
      #define SERIAL_SUM_PPM         ROLL,PITCH,THROTTLE,YAW,AUX1,AUX2,AUX3,AUX4,8,9,10,11 // EchoWiiTX
...
/*************************************************************************************************/
  ...
  // Englebert: WaveRider 1.0
  // #define OVERRIDE_LEDPIN_PINMODE               pinMode (13, OUTPUT); // Use D13
  // #define OVERRIDE_LEDPIN_TOGGLE                PINB |= 1<<5;          //switch LEDPIN state (digital PIN 13)
  // #define OVERRIDE_LEDPIN_OFF                   PORTB &= ~(1<<5);
  // #define OVERRIDE_LEDPIN_ON                    PORTB |= (1<<5);
 ...
 */
  ...
  /********************************    LED FLASHER    ***********************************/
    ...
    #define LED_FLASHER_SEQUENCE_LOW    0b00100001      // no illumination
